...
- The legislation register is public. `msp_public_instrument_register` (migration 046) lists every verified instrument with its full citation, gazette reference, verification date, next review and the industries it applies to. The Build your Plan page reads it live and offers it as a dated PDF and CSV release under vercel/downloads/. A new release of the register means a new dated file there, generated from the view, and the release line on the page updated.
