...
- Migration 056 (element name, guidance rows, hsf_client_register) is NOT applied to live: it needs the Director's confirmation. Until it is, File registration on live answers 503 "File registration is not available yet" and the signed in builder still shows the old HSF-E-01 name.
