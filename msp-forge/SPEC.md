...
| HSF-10 | confirm | Published register PDF (vercel/downloads/CNC-Legislation-Register-v1.0.0.pdf): cross reference offsets do not match the file bytes; regenerate at the next register release | Build | Open |
