// CNC HSF FORGE | BI-EDGE-01 v1.0.0 | Bee-Inspect Edge Function: claim-code-create 26/09/2026
//
// Deliberately thin, in the style of hsf-mco-transfer: all logic lives in the
// plain ES module ../_shared/bi/handlers/claim-code-create.js, which node --test exercises with
...
import { handle } from "../_shared/bi/handlers/claim-code-create.js";
