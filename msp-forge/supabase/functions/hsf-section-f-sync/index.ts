// CNC HSF FORGE | BI-EDGE-01 v1.0.0 | Bee-Inspect Edge Function: hsf-section-f-sync 26/09/2026
//
// Deliberately thin, in the style of hsf-mco-transfer: all logic lives in the
// plain ES module ../_shared/bi/handlers/hsf-section-f-sync.js, which node --test exercises with
...
import { handle } from "../_shared/bi/handlers/hsf-section-f-sync.js";
